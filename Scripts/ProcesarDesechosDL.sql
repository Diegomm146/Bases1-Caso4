...
CREATE PROCEDURE [dbo].[ProcesarDesechosDL]
...
BEGIN
    ...
    BEGIN TRY
        ...
        WHERE pr.idpuntorecoleccion = @idpuntorecoleccion
            AND td.nombre IN (SELECT nombre FROM @desechosaprocesar) AND d.enabled = 1;
